...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER', 'CONFIRMED', 'SHIPPED', 'DELIVERED', 'REVIEW', 'SYSTEM');
...
-- CreateIndex
CREATE UNIQUE INDEX "SellerReview_userId_sellerId_orderId_key" ON "SellerReview"("userId", "sellerId", "orderId");
